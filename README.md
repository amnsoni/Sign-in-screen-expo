...
in this project i'm trying to implement a Sign in screen 
in which it has logo, form input, sumbit button, and links 

if you want to run this project on your local machine please git clone this project 
and then cd to this project.

then run 
``` bash
    npm install 
````
    for installing the dependencies after installing dependecies
